...
, function(t, e, n) {
    ...
    void 0 === (i = function(t) {
        ...
        p5.Effect.prototype.amp = function(t, e, n) {
            ...
            this.output.gain.linearRampToValueAtTime(t, i + n + e + .001)
        }
        ,
            ...
            convertToWav: function(t) {
                var e, n = function(t, e) {
                    for (var n = t.length + e.length, i = new Float32Array(n), o = 0, r = 0; r < n; )
                        ...
                        o++;
                    return i
                }(e = t.getChannelData(0), 1 < t.numberOfChannels ? t.getChannelData(1) : e), i = new window.ArrayBuffer(44 + 2 * n.length), o = new window.DataView(i);
                p(o, 0, "RIFF"),
...
, function(t, e, n) {
    ...
    void 0 === (o = function(i) {
        ...
        i.supported && (o = AudioNode.prototype.connect,
...
, function(i, o, r) {
    ...
    (function(t) {
        ...
        e = [r(35), r(12), r(0)],
        void 0 === (n = function(i, t, e) {
            var o = new window.AudioContext;
            return e.context.dispose(),
            e.setContext(o),
...
, function(t, e, n) {
    ...
    void 0 === (i = function(t) {
        ...
        p5.Oscillator = function(t, e) {
            ...
            this.output.gain.setValueAtTime(.5, s.audiocontext.currentTime),
        ...
        p5.Oscillator.prototype.start = function(t, e) {
            ...
            if (!this.started) {
                ...
                for (var r in this.oscillator && (this.oscillator.disconnect(),
                ...
                this._freqMods)
                    void 0 !== this._freqMods[r].connect && this._freqMods[r].connect(this.oscillator.frequency);
                this.started = !0
            }
        }
        ,
        ...
        p5.Oscillator.prototype.freq = function(t, e, n) {
            if ("number" != typeof t || isNaN(t)) {
                ...
                n = n || 0,
                e = e || 0;
                0 === e ? this.oscillator.frequency.setValueAtTime(t, n + i) : 0 < t ? this.oscillator.frequency.exponentialRampToValueAtTime(t, n + e + i) : this.oscillator.frequency.linearRampToValueAtTime(t, n + e + i),
        ...
        p5.Oscillator.prototype.connect = function(t) {
            ...
            this.connection = t) : this.panner.connect(s.input)
        }
        ,
        ...
        p5.Oscillator.prototype.phase = function(t) {
            var e = p5.prototype.map(t, 0, 1, 0, 1 / this.f)
              , n = s.audiocontext.currentTime;
            this.phaseAmount = t,
            this.dNode || (this.dNode = s.audiocontext.createDelay(),
        ...
        p5.Oscillator.prototype.scale = function(t, e, n, i) {
            var o, r;
            r = 4 === arguments.length ? (o = p5.prototype.map(n, t, e, 0, 1) - .5,
            p5.prototype.map(i, t, e, 0, 1) - .5) : (o = t,
            e);
            var s = new p(o,r)
...
, function(t, e, n) {
    ...
    void 0 === (o = function(o) {
        ...
        o.Clock.prototype.start = function(t, e) {
            return t = this.toSeconds(t),
            this._state.getValueAtTime(t) !== o.State.Started && this._state.add({
        ...
        o.Clock.prototype.pause = function(t) {
            return t = this.toSeconds(t),
            this._state.getValueAtTime(t) === o.State.Started && this._state.setStateAtTime(o.State.Paused, t),
            this
        }
        ,
        o.Clock.prototype._loop = function() {
            for (var t = this.now() + this.context.lookAhead + this.context.updateInterval + 2 * this.context.lag; t > this._nextTick && this._state; ) {
                ...
                if (e !== this._lastState) {
                    ...
                    e === o.State.Started ? (this._nextTick = n.time,
                    this.isUndef(n.offset) || (this.ticks = n.offset),
                    this.emit("start", n.time, this.ticks)) : e === o.State.Stopped ? (this.ticks = 0,
                    this.emit("stop", n.time)) : e === o.State.Paused && this.emit("pause", n.time)
                }
                var i = this._nextTick;
                this.frequency && (this._nextTick += 1 / this.frequency.getValueAtTime(this._nextTick),
                e === o.State.Started && (this.callback(i),
                this.ticks++))
            }
        }
        ,
...
, function(t, e, n) {
    ...
    void 0 === (i = function(t) {
        ...
        p5.PolySynth.prototype.noteAttack = function(t, e, n) {
            n = ~~n;
            var i, o = c.audiocontext.currentTime + n, r = l(t), s = e || .1;
            if (this.notes[r] && null !== this.notes[r].getValueAtTime(o) && this.noteRelease(r, 0),
...
, function(t, e, n) {
    ...
    void 0 === (i = function(t) {
        ...
        p5.Panner.prototype.disconnect = function() {
            ...
            1 < n ? (this.splitter = a.createChannelSplitter(2),
        ...
        p5.Panner.prototype.inputChannels = function(t) {
            ...
            this.input.connect(this.right)) : 2 === t && (o("undefined" === this.splitter) && (this.splitter = a.createChannelSplitter(2)),
...
, function(t, e, o) {
    ...
    void 0 === (n = function(t) {
        ...
        p5.SoundFile = function(t, e, n, i) {
            if (void 0 !== t) {
                if ("string" == typeof t || "string" == typeof t[0]) {
                    ...
                    this.url = o
                } else if ("object" === l(t) && !(window.File && window.FileReader && window.FileList && window.Blob))
        ...
        p5.SoundFile.prototype.play = function(t, e, n, i, o) {
            if (this.output) {
                ...
                "untildone" !== this.mode || !this.isPlaying()) {
                    ...
                    this._paused ? (this.bufferSourceNode.start(a, this.pauseTime, o),
                    this._counterNode.start(a, this.pauseTime, o)) : (this.bufferSourceNode.start(a, r, o),
        ...
        p5.SoundFile.prototype._initCounterNode = function() {
            ...
            ,
            i.buffer = function(t) {
                for (var e = t.length, n = p.createBuffer(1, t.length, p.sampleRate), i = n.getChannelData(0), o = 0; o < e; o++)
                    i[o] = o;
                return n
            }(n.buffer),
        ...
        p5.SoundFile.prototype.processPeaks = function(r, t, e, n) {
            ...
            h.oncomplete = function(t) {
                if (self.panner) {
                    for (var e = t.renderedBuffer, n = e.getChannelData(0); a = d(n, u),
                    u -= .005,
...
, function(t, e, o) {
    ...
    void 0 === (n = function(t) {
        ...
        p5.Amplitude.prototype.setInput = function(t, e) {
            ...
            null == t ? n.meter.connect(this._workletNode) : t instanceof p5.Signal ? t.output.connect(this._workletNode) : t ? (t.connect(this._workletNode),
            this._workletNode.disconnect(),
            this._workletNode.connect(this.output)) : n.meter.connect(this._workletNode)
        }
        ,
...
, function(t, e, o) {
    ...
    void 0 === (n = function(t) {
        ...
        p5.FFT.prototype.setInput = function(t) {
            ...
            c.fftMeter.disconnect()) : c.fftMeter.connect(this.analyser)
        }
        ,
        p5.FFT.prototype.waveform = function() {
            for (var t, e, n = 0; n < arguments.length; n++)
                "number" == typeof arguments[n] && (t = arguments[n],
                this.analyser.fftSize = 2 * t),
                "string" == typeof arguments[n] && (e = arguments[n]);
            if (e && !p5.prototype._isSafari())
                return s(this, this.timeDomain),
        ...
        p5.FFT.prototype.analyze = function() {
            ...
            return t && "db" === t.toLowerCase() ? (n(this),
            this.analyser.getFloatFrequencyData(this.freqDomain),
            this.freqDomain) : (i(this, this.freqDomain),
        ...
        p5.FFT.prototype.getEnergy = function(t, e) {
            ...
            if (e) {
                if (t && e) {
                    ...
                    for (var o = Math.round(t / n * this.freqDomain.length), r = Math.round(e / n * this.freqDomain.length), s = 0, a = 0, u = o; u <= r; u++)
                        s += this.freqDomain[u],
                        a += 1;
                    return s / a
                }
        ...
        p5.FFT.prototype.getCentroid = function() {
            for (var t = c.audiocontext.sampleRate / 2, e = 0, n = 0, i = 0; i < this.freqDomain.length; i++)
        ...
        p5.FFT.prototype.linAverages = function(t) {
            t = t || 16;
            for (var e = this.freqDomain, n = e.length, i = Math.floor(n / t), o = new Array(t), r = 0, s = 0; s < n; s++)
...
, function(t, e, n) {
    ...
    void 0 === (i = function(t) {
        ...
        p5.Envelope.prototype.ramp = function(t, e, n, i) {
            ...
            a < r ? (this.control.setTargetAtTime(r, o, this._rampAttackTC),
            o += this._rampAttackTime) : r < a && (this.control.setTargetAtTime(r, o, this._rampDecayTC),
            o += this._rampDecayTime),
            void 0 !== s && (r < s ? this.control.setTargetAtTime(s, o, this._rampAttackTC) : s < r && this.control.setTargetAtTime(s, o, this._rampDecayTC))
        }
        ,
...
, function(t, e, n) {
    ...
    void 0 === (i = function(t) {
        var s = n(1);
        function a() {
            for (var t = s.audiocontext, e = t.createBuffer(1, 2048, t.sampleRate), n = e.getChannelData(0), i = 0; i < 2048; i++)
                n[i] = 1;
...
, function(t, e, r) {
    ...
    void 0 === (n = function(t) {
        ...
        var n = function() {
            for (var t = 2 * l.audiocontext.sampleRate, e = l.audiocontext.createBuffer(1, t, l.audiocontext.sampleRate), n = e.getChannelData(0), i = 0; i < t; i++)
                n[i] = 2 * Math.random() - 1;
            return e.type = "white",
            e
        }()
          , i = function() {
            var t, e, n, i, o, r, s, a = 2 * l.audiocontext.sampleRate, u = l.audiocontext.createBuffer(1, a, l.audiocontext.sampleRate), p = u.getChannelData(0);
            t = e = n = i = o = r = s = 0;
            for (var c = 0; c < a; c++) {
...
, function(t, e, n) {
    ...
    void 0 === (i = function(t) {
        ...
        p5.AudioIn.prototype.start = function(e, n) {
            ...
            window.navigator.mediaDevices.getUserMedia(o).then(function(t) {
                i.stream = t,
                i.enabled = !0,
    ...
    void 0 === (o = function(u) {
        ...
        u.Expr.prototype._parseTree = function(t) {
            ...
            function a(t) {
                ...
                e = t < 0 ? function t() {
                    var e, n;
                    return r(e = i.peek(), "unary") ? (e = i.next(),
                    n = t(),
                    {
                        operator: e.value,
                        method: e.method,
    ...
    void 0 === (n = function(t) {
        ...
        return p5.EQ = function(t) {
            ...
            for (var o = 0; o < t; o++)
                i = o === t - 1 ? (n = 21e3,
                .01) : 0 === o ? (n = 100,
                .1) : (n = 1 === o ? 3 === t ? 360 * e : 360 : this.bands[o - 1].freq() * e,
                1),
                this.bands[o] = this._newBand(n, i),
                0 < o ? this.bands[o - 1].connect(this.bands[o].biquad) : this.input.connect(this.bands[o].biquad);
        ...
        p5.EQ.prototype.dispose = function() {
            if (r.prototype.dispose.apply(this),
            this.bands) {
...
, function(t, e, o) {
    ...
    void 0 === (n = function(t) {
        ...
        var n = o(15)
          , i = o(1);
        return (e.prototype = Object.create(n.prototype)).amp = function() {}
        ,
...
, function(t, e, n) {
    ...
    void 0 === (i = function(t) {
        ...
        p5.Reverb.prototype._buildImpulse = function() {
            var t, e, n = this.ac.sampleRate, i = n * this._seconds, o = this._decay, r = this.ac.createBuffer(2, i, n), s = r.getChannelData(0), a = r.getChannelData(1);
            for (e = 0; e < i; e++)
    ...
    void 0 === (n = function(t) {
        ...
        p5.Score = function() {
            ...
            for (var e in arguments)
                arguments[e] && this.parts[e] && (this.parts[e] = arguments[e],
...
, function(t, e, n) {
    ...
    void 0 === (i = function(t) {
        var i = n(4);
        function o(t) {
            for (var e, n = "number" == typeof t ? t : 50, i = new Float32Array(44100), o = Math.PI / 180, r = 0; r < 44100; ++r)
                e = 2 * r / 44100 - 1,
