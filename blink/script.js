const state = {
  ...
  let model,
    ...
    video,
    canvas,
    button = document.getElementById('turnon');
  ...
  async function main() {
    ...
    renderPrediction();
    setTimeout(function(){ window.setInterval(hh, 7000); }, 7000);
    console.log("timer");
  }
  
  //Once the user has clicked, start the main function
  button.addEventListener('click', function () {
    button.innerHTML = 'allow camera access';
